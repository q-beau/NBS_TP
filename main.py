...
ShowUncertainty = False #Sets visibility of uncertainty curves
...
#Filer over the reporting period
rp = 5 #reporting period in years
...
fig = px.scatter_3d(
    ...
    z='final_SOC',
    color='ROT',
    error_z='final_SOC_sd',  # Add error bars in z-axis (if supported)
...
print(f"Most negative scenario:\n{min_scenario}\n")
