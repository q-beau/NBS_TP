...
def create_yield_table(vegetation_data_path, crop_names_dict, bolinder_coeff_table):
    ...
    additional_crops = [
        {"Crop species": "Rapeseed", "Avg harvested biomass (t/ha)": 3, "Std harvested biomass (t/ha)": 0.3},
        {"Crop species": "Cameline", "Avg harvested biomass (t/ha)": 1.5, "Std harvested biomass (t/ha)": 0.15},
        {"Crop species": "Faba", "Avg harvested biomass (t/ha)": 3.0, "Std harvested biomass (t/ha)": 0.3},
        {"Crop species": "Oat", "Avg harvested biomass (t/ha)": 6.8, "Std harvested biomass (t/ha)": 0.7},
        {"Crop species": "Pea", "Avg harvested biomass (t/ha)": 3.0, "Std harvested biomass (t/ha)": 0.3}
    ]
    ...
    final_yield_table = merged[
        ["Crop species", "Avg harvested biomass (t/ha)", "Std harvested biomass (t/ha)","Avg yield (t/ha)", "Std yield (t/ha)", "Crop code", "Cin_Bol"]
    ]
